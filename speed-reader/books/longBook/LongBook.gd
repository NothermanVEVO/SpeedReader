...
@onready var _cover_image : TextureRect = $Cover
@onready var _title_text : RichTextLabel = $Info/Title
@onready var _reading_type : OptionButton = $Info/Reading
@onready var _stars : SpinBox = $Info/Stars
